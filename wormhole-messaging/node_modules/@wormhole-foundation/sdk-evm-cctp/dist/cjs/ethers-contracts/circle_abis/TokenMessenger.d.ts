...
export interface TokenMessengerInterface extends Interface {
    getFunction(nameOrSignature: 'acceptOwnership' | 'addLocalMinter' | 'addRemoteTokenMessenger' | 'depositForBurn' | 'depositForBurnWithCaller' | 'handleReceiveMessage' | 'localMessageTransmitter' | 'localMinter' | 'messageBodyVersion' | 'owner' | 'pendingOwner' | 'remoteTokenMessengers' | 'removeLocalMinter' | 'removeRemoteTokenMessenger' | 'replaceDepositForBurn' | 'rescueERC20' | 'rescuer' | 'transferOwnership' | 'updateRescuer'): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: 'DepositForBurn' | 'LocalMinterAdded' | 'LocalMinterRemoved' | 'MintAndWithdraw' | 'OwnershipTransferStarted' | 'OwnershipTransferred' | 'RemoteTokenMessengerAdded' | 'RemoteTokenMessengerRemoved' | 'RescuerChanged'): EventFragment;
    encodeFunctionData(functionFragment: 'acceptOwnership', values?: undefined): string;
    encodeFunctionData(functionFragment: 'addLocalMinter', values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: 'depositForBurnWithCaller', values: [BigNumberish, BigNumberish, BytesLike, AddressLike, BytesLike]): string;
    encodeFunctionData(functionFragment: 'handleReceiveMessage', values: [BigNumberish, BytesLike, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'replaceDepositForBurn', values: [BytesLike, BytesLike, BytesLike, BytesLike]): string;
...
export declare namespace LocalMinterAddedEvent {
    type InputTuple = [localMinter: AddressLike];
    type OutputTuple = [localMinter: string];
    interface OutputObject {
        localMinter: string;
    }
    type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export declare namespace LocalMinterRemovedEvent {
    type InputTuple = [localMinter: AddressLike];
    type OutputTuple = [localMinter: string];
    interface OutputObject {
        localMinter: string;
...
export declare namespace MintAndWithdrawEvent {
    type InputTuple = [
...
export declare namespace RemoteTokenMessengerAddedEvent {
    type InputTuple = [domain: BigNumberish, tokenMessenger: BytesLike];
    type OutputTuple = [domain: bigint, tokenMessenger: string];
    interface OutputObject {
        domain: bigint;
...
export declare namespace RemoteTokenMessengerRemovedEvent {
    type InputTuple = [domain: BigNumberish, tokenMessenger: BytesLike];
    type OutputTuple = [domain: bigint, tokenMessenger: string];
    interface OutputObject {
        domain: bigint;
...
export interface TokenMessenger extends BaseContract {
    ...
    getFunction(nameOrSignature: 'addLocalMinter'): TypedContractMethod<[newLocalMinter: AddressLike], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'addRemoteTokenMessenger'): TypedContractMethod<[
        domain: BigNumberish,
        tokenMessenger: BytesLike
    ], [
        void
    ...
    getFunction(nameOrSignature: 'depositForBurnWithCaller'): TypedContractMethod<[
        amount: BigNumberish,
        destinationDomain: BigNumberish,
        mintRecipient: BytesLike,
        burnToken: AddressLike,
    ...
    getFunction(nameOrSignature: 'handleReceiveMessage'): TypedContractMethod<[
        remoteDomain: BigNumberish,
        sender: BytesLike,
        messageBody: BytesLike
    ], [
    ...
    getFunction(nameOrSignature: 'localMessageTransmitter'): TypedContractMethod<[], [string], 'view'>;
    getFunction(nameOrSignature: 'localMinter'): TypedContractMethod<[], [string], 'view'>;
    getFunction(nameOrSignature: 'messageBodyVersion'): TypedContractMethod<[], [bigint], 'view'>;
    getFunction(nameOrSignature: 'owner'): TypedContractMethod<[], [string], 'view'>;
    getFunction(nameOrSignature: 'pendingOwner'): TypedContractMethod<[], [string], 'view'>;
    getFunction(nameOrSignature: 'remoteTokenMessengers'): TypedContractMethod<[arg0: BigNumberish], [string], 'view'>;
    getFunction(nameOrSignature: 'removeLocalMinter'): TypedContractMethod<[], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'removeRemoteTokenMessenger'): TypedContractMethod<[domain: BigNumberish], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'replaceDepositForBurn'): TypedContractMethod<[
        originalMessage: BytesLike,
        originalAttestation: BytesLike,
        newDestinationCaller: BytesLike,
        newMintRecipient: BytesLike
    ...
    getEvent(key: 'LocalMinterAdded'): TypedContractEvent<LocalMinterAddedEvent.InputTuple, LocalMinterAddedEvent.OutputTuple, LocalMinterAddedEvent.OutputObject>;
    getEvent(key: 'LocalMinterRemoved'): TypedContractEvent<LocalMinterRemovedEvent.InputTuple, LocalMinterRemovedEvent.OutputTuple, LocalMinterRemovedEvent.OutputObject>;
    getEvent(key: 'MintAndWithdraw'): TypedContractEvent<MintAndWithdrawEvent.InputTuple, MintAndWithdrawEvent.OutputTuple, MintAndWithdrawEvent.OutputObject>;
    ...
    getEvent(key: 'RemoteTokenMessengerAdded'): TypedContractEvent<RemoteTokenMessengerAddedEvent.InputTuple, RemoteTokenMessengerAddedEvent.OutputTuple, RemoteTokenMessengerAddedEvent.OutputObject>;
    getEvent(key: 'RemoteTokenMessengerRemoved'): TypedContractEvent<RemoteTokenMessengerRemovedEvent.InputTuple, RemoteTokenMessengerRemovedEvent.OutputTuple, RemoteTokenMessengerRemovedEvent.OutputObject>;
    ...
    filters: {
        ...
        'LocalMinterAdded(address)': TypedContractEvent<LocalMinterAddedEvent.InputTuple, LocalMinterAddedEvent.OutputTuple, LocalMinterAddedEvent.OutputObject>;
        LocalMinterAdded: TypedContractEvent<LocalMinterAddedEvent.InputTuple, LocalMinterAddedEvent.OutputTuple, LocalMinterAddedEvent.OutputObject>;
        'LocalMinterRemoved(address)': TypedContractEvent<LocalMinterRemovedEvent.InputTuple, LocalMinterRemovedEvent.OutputTuple, LocalMinterRemovedEvent.OutputObject>;
        LocalMinterRemoved: TypedContractEvent<LocalMinterRemovedEvent.InputTuple, LocalMinterRemovedEvent.OutputTuple, LocalMinterRemovedEvent.OutputObject>;
        'MintAndWithdraw(address,uint256,address)': TypedContractEvent<MintAndWithdrawEvent.InputTuple, MintAndWithdrawEvent.OutputTuple, MintAndWithdrawEvent.OutputObject>;
        MintAndWithdraw: TypedContractEvent<MintAndWithdrawEvent.InputTuple, MintAndWithdrawEvent.OutputTuple, MintAndWithdrawEvent.OutputObject>;
        ...
        'RemoteTokenMessengerAdded(uint32,bytes32)': TypedContractEvent<RemoteTokenMessengerAddedEvent.InputTuple, RemoteTokenMessengerAddedEvent.OutputTuple, RemoteTokenMessengerAddedEvent.OutputObject>;
        RemoteTokenMessengerAdded: TypedContractEvent<RemoteTokenMessengerAddedEvent.InputTuple, RemoteTokenMessengerAddedEvent.OutputTuple, RemoteTokenMessengerAddedEvent.OutputObject>;
        'RemoteTokenMessengerRemoved(uint32,bytes32)': TypedContractEvent<RemoteTokenMessengerRemovedEvent.InputTuple, RemoteTokenMessengerRemovedEvent.OutputTuple, RemoteTokenMessengerRemovedEvent.OutputObject>;
        RemoteTokenMessengerRemoved: TypedContractEvent<RemoteTokenMessengerRemovedEvent.InputTuple, RemoteTokenMessengerRemovedEvent.OutputTuple, RemoteTokenMessengerRemovedEvent.OutputObject>;
