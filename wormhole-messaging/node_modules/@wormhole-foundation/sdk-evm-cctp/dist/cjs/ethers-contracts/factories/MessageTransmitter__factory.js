...
class MessageTransmitter__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            ...
            super(_abi, MessageTransmitter__factory.linkBytecode(linkLibraryAddresses), signer);
        }
    }
    static linkBytecode(linkLibraryAddresses) {
        let linkedBytecode = _bytecode;
        linkedBytecode = linkedBytecode.replace(new RegExp('__\\$8c977731748aa4504deed57239565df533\\$__', 'g'), linkLibraryAddresses['src/messages/Message.sol:Message']
            .replace(/^0x/, '')
            .toLowerCase());
        return linkedBytecode;
    }
    getDeployTransaction(_localDomain, _attester, _maxMessageBodySize, _version, overrides) {
        return super.getDeployTransaction(_localDomain, _attester, _maxMessageBodySize, _version, overrides || {});
    }
    deploy(_localDomain, _attester, _maxMessageBodySize, _version, overrides) {
        return super.deploy(_localDomain, _attester, _maxMessageBodySize, _version, overrides || {});
    }
    connect(runner) {
