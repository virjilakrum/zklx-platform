...
class TokenMessenger__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            ...
            super(_abi, TokenMessenger__factory.linkBytecode(linkLibraryAddresses), signer);
        }
    }
    ...
    getDeployTransaction(_messageTransmitter, _messageBodyVersion, overrides) {
        return super.getDeployTransaction(_messageTransmitter, _messageBodyVersion, overrides || {});
    }
    deploy(_messageTransmitter, _messageBodyVersion, overrides) {
        return super.deploy(_messageTransmitter, _messageBodyVersion, overrides || {});
    }
    connect(runner) {
