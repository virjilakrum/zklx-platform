...
export declare class MessageTransmitter__factory extends ContractFactory {
    ...
    static connect(address: string, runner?: ContractRunner | null): MessageTransmitter;
}
export interface MessageTransmitterLibraryAddresses {
