...
export declare class TokenMessenger__factory extends ContractFactory {
    ...
    static connect(address: string, runner?: ContractRunner | null): TokenMessenger;
}
export interface TokenMessengerLibraryAddresses {
