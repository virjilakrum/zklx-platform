...
class TokenTransfer {
    ...
    static async fromIdentifier(wh, id, timeout) {
        ...
        const scaledAmount = sdk_base_1.amount.scale(sdk_base_1.amount.fromBaseUnits(token.amount, TokenTransfer.MAX_DECIMALS), await wh.getDecimals(token.chain, token.address));
