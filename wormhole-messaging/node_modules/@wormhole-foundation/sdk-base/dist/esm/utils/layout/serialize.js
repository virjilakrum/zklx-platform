...
import { checkItemSize, checkBytesTypeEqual, checkNumEquals, findIdLayoutPair, isFixedBytesConversion, isLayoutItem, isNumType, isBytesType, } from './utils.js';
...
export function serializeNum(val, size, cursor, endianness = defaultEndianness, signed = false) {
    if (!signed && val < 0)
