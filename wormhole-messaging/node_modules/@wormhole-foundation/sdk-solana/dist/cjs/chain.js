...
class SolanaChain extends sdk_connect_1.ChainContext {
    async getTokenAccount(address, token) {
        ...
        const mint = new address_js_1.SolanaAddress(token).unwrap();
        const owner = new address_js_1.SolanaAddress(address).unwrap();
        const ata = await getAssociatedTokenAddress(mint, owner);
        return {
            chain: this.chain,
            address: new address_js_1.SolanaAddress(ata.toString()),
        };
    }
}
