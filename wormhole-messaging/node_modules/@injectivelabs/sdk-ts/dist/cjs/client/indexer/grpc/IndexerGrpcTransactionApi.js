...
class IndexerGrpcTransactionApi {
    ...
    prepareTxRequest(_a) {
        return __awaiter(this, arguments, void 0, function* ({ address, chainId, message, memo, estimateGas = true, gasLimit = utils_1.DEFAULT_GAS_LIMIT, feeDenom = utils_1.DEFAULT_BRIDGE_FEE_DENOM, feePrice = utils_1.DEFAULT_BRIDGE_FEE_PRICE, timeoutHeight, }) {
    ...
    prepareExchangeTxRequest(_a) {
        return __awaiter(this, arguments, void 0, function* ({ address, chainId, message, memo, estimateGas = true, gasLimit = utils_1.DEFAULT_EXCHANGE_LIMIT, feeDenom = utils_1.DEFAULT_BRIDGE_FEE_DENOM, feePrice = utils_1.DEFAULT_BRIDGE_FEE_PRICE, timeoutHeight, delegatedFee, }) {
            const txFeeAmount = core_proto_ts_1.CosmosBaseV1Beta1Coin.Coin.create();
            txFeeAmount.denom = feeDenom;
            txFeeAmount.amount = feePrice;
            const cosmosTxFee = indexer_proto_ts_1.InjectiveExchangeRpc.CosmosTxFee.create();
