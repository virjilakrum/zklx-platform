...
class IndexerGrpcMitoTransformer {
    ...
    static mitoIDOClaimedCoinsToIDOClaimedCoins(claimedCoins) {
        return {
            claimedCoins: claimedCoins.claimedCoins.map(IndexerGrpcMitoTransformer.grpcCoinToCoin),
    ...
    static mitoVestingCOonfigToVestingConfig(config) {
        return {
            ...
            vestingDurationSeconds: parseInt((config === null || config === void 0 ? void 0 : config.vestingDurationSeconds) || '0', 10),
            vestingStartDelaySeconds: parseInt((config === null || config === void 0 ? void 0 : config.vestingDurationSeconds) || '0', 10),
        };
    }
