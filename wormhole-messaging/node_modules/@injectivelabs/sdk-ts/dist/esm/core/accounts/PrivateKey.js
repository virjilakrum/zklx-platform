...
import { InjectiveTypesV1TxExt, } from '@injectivelabs/core-proto-ts';
...
export class PrivateKey {
    ...
    static verifyCosmosSignature({ txRaw, signer, }) {
        ...
        const getChainIds = () => {
            ...
            const decodedExtension = InjectiveTypesV1TxExt.ExtensionOptionsWeb3Tx.decode(extension.value);
