...
function createBaseEventCodeStored() {
    return { codeId: "0", creator: "", accessConfig: undefined, checksum: new Uint8Array(0) };
}
exports.EventCodeStored = {
    ...
    toJSON(message) {
        ...
        if (message.accessConfig !== undefined) {
            obj.accessConfig = exports.AccessConfig.toJSON(message.accessConfig);
        }
        if (message.checksum.length !== 0) {
...
function createBaseEventContractInstantiated() {
    return { contractAddress: "", admin: "", codeId: "0", funds: [], msg: new Uint8Array(0), label: "", creator: "" };
}
...
function createBaseEventContractMigrated() {
    return { codeId: "0", contractAddress: "", msg: new Uint8Array(0) };
}
