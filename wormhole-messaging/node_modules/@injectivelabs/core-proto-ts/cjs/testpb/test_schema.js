...
exports.ExampleAutoIncFieldName = exports.SimpleExample = exports.ExampleTimestamp = exports.ExampleSingleton = exports.ExampleAutoIncrementTable = exports.ExampleTable_ExampleMessage = exports.ExampleTable_MapEntry = exports.ExampleTable = exports.enumToJSON = exports.enumFromJSON = exports.Enum = void 0;
/* eslint-disable */
...
exports.ExampleTable = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.ts !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.ts), writer.uint32(42).fork()).ldelim();
        }
        if (message.dur !== undefined) {
            duration_1.Duration.encode(message.dur, writer.uint32(50).fork()).ldelim();
        }
        if (message.i32 !== 0) {
        ...
        Object.entries(message.map).forEach(([key, value]) => {
            exports.ExampleTable_MapEntry.encode({ key: key, value }, writer.uint32(146).fork()).ldelim();
        });
        if (message.msg !== undefined) {
            exports.ExampleTable_ExampleMessage.encode(message.msg, writer.uint32(154).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    message.dur = duration_1.Duration.decode(reader, reader.uint32());
                    continue;
                case 7:
                    if (tag !== 56) {
                        break;
                ...
                case 18:
                    ...
                    const entry18 = exports.ExampleTable_MapEntry.decode(reader, reader.uint32());
                ...
                case 19:
                    ...
                    message.msg = exports.ExampleTable_ExampleMessage.decode(reader, reader.uint32());
                    continue;
                case 20:
                    if (tag !== 160) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            dur: isSet(object.dur) ? duration_1.Duration.fromJSON(object.dur) : undefined,
            ...
            map: isObject(object.map)
                ...
                : {},
            msg: isSet(object.msg) ? exports.ExampleTable_ExampleMessage.fromJSON(object.msg) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.dur !== undefined) {
            obj.dur = duration_1.Duration.toJSON(message.dur);
        }
        if (message.i32 !== 0) {
        ...
        if (message.msg !== undefined) {
            obj.msg = exports.ExampleTable_ExampleMessage.toJSON(message.msg);
        }
        if (message.oneof !== undefined) {
    ...
    create(base) {
        return exports.ExampleTable.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.dur = (object.dur !== undefined && object.dur !== null) ? duration_1.Duration.fromPartial(object.dur) : undefined;
        ...
        message.msg = (object.msg !== undefined && object.msg !== null)
            ? exports.ExampleTable_ExampleMessage.fromPartial(object.msg)
            : undefined;
...
exports.ExampleTable_MapEntry = {
    ...
    create(base) {
        return exports.ExampleTable_MapEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseExampleTable_MapEntry();
...
exports.ExampleTable_ExampleMessage = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.foo !== "") {
    ...
    create(base) {
        return exports.ExampleTable_ExampleMessage.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseExampleTable_ExampleMessage();
...
exports.ExampleAutoIncrementTable = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.id !== "0") {
    ...
    create(base) {
        return exports.ExampleAutoIncrementTable.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseExampleAutoIncrementTable();
...
exports.ExampleSingleton = {
    ...
    create(base) {
        return exports.ExampleSingleton.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseExampleSingleton();
...
exports.ExampleTimestamp = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.ts !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.ts), writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.ExampleTimestamp.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseExampleTimestamp();
...
exports.SimpleExample = {
    ...
    create(base) {
        return exports.SimpleExample.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseSimpleExample();
...
exports.ExampleAutoIncFieldName = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.foo !== "0") {
    ...
    create(base) {
        return exports.ExampleAutoIncFieldName.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseExampleAutoIncFieldName();
