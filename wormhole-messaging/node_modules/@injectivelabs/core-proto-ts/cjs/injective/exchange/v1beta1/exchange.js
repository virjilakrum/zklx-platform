...
exports.Params = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.spotMarketInstantListingFee !== undefined) {
            obj.spotMarketInstantListingFee = coin_1.Coin.toJSON(message.spotMarketInstantListingFee);
        }
        if (message.derivativeMarketInstantListingFee !== undefined) {
            obj.derivativeMarketInstantListingFee = coin_1.Coin.toJSON(message.derivativeMarketInstantListingFee);
        }
        if (message.defaultSpotMakerFeeRate !== "") {
        ...
        if (message.binaryOptionsMarketInstantListingFee !== undefined) {
            obj.binaryOptionsMarketInstantListingFee = coin_1.Coin.toJSON(message.binaryOptionsMarketInstantListingFee);
        }
        if (message.atomicMarketOrderAccessLevel !== 0) {
...
exports.SpotOrder = {
    ...
    toJSON(message) {
        ...
        if (message.orderInfo !== undefined) {
            obj.orderInfo = exports.OrderInfo.toJSON(message.orderInfo);
        }
        if (message.orderType !== 0) {
...
exports.SubaccountOrderData = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.order !== undefined) {
            obj.order = exports.SubaccountOrder.toJSON(message.order);
        }
        if (message.orderHash.length !== 0) {
            obj.orderHash = base64FromBytes(message.orderHash);
        }
...
exports.DerivativeTradeLog = {
    ...
    toJSON(message) {
        ...
        if (message.positionDelta !== undefined) {
            obj.positionDelta = exports.PositionDelta.toJSON(message.positionDelta);
        }
        if (message.payout !== "") {
...
exports.SubaccountDeposit = {
    ...
    toJSON(message) {
        ...
        if (message.deposit !== undefined) {
            obj.deposit = exports.Deposit.toJSON(message.deposit);
        }
        return obj;
    },
    create(base) {
    ...
    fromJSON(object) {
        return {
            ...
            deposits: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.deposits)
                ? object.deposits.map((e) => exports.SubaccountDeposit.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_a = message.deposits) === null || _a === void 0 ? void 0 : _a.length) {
            obj.deposits = message.deposits.map((e) => exports.SubaccountDeposit.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
exports.TradingRewardCampaignBoostInfo = {
    ...
    toJSON(message) {
        ...
        if ((_b = message.spotMarketMultipliers) === null || _b === void 0 ? void 0 : _b.length) {
            obj.spotMarketMultipliers = message.spotMarketMultipliers.map((e) => exports.PointsMultiplier.toJSON(e));
        }
        ...
        if ((_d = message.derivativeMarketMultipliers) === null || _d === void 0 ? void 0 : _d.length) {
            obj.derivativeMarketMultipliers = message.derivativeMarketMultipliers.map((e) => exports.PointsMultiplier.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
exports.CampaignRewardPool = {
    ...
    toJSON(message) {
        ...
        if ((_a = message.maxCampaignRewards) === null || _a === void 0 ? void 0 : _a.length) {
            obj.maxCampaignRewards = message.maxCampaignRewards.map((e) => coin_1.Coin.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
exports.TradingRewardCampaignInfo = {
    ...
    toJSON(message) {
        ...
        if (message.tradingRewardBoostInfo !== undefined) {
            obj.tradingRewardBoostInfo = exports.TradingRewardCampaignBoostInfo.toJSON(message.tradingRewardBoostInfo);
        }
...
exports.FeeDiscountSchedule = {
    ...
    toJSON(message) {
        ...
        if ((_b = message.tierInfos) === null || _b === void 0 ? void 0 : _b.length) {
            obj.tierInfos = message.tierInfos.map((e) => exports.FeeDiscountTierInfo.toJSON(e));
        }
...
exports.AccountRewards = {
    ...
    fromJSON(object) {
        return {
            ...
            rewards: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.rewards) ? object.rewards.map((e) => coin_1.Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
        ...
        if ((_a = message.rewards) === null || _a === void 0 ? void 0 : _a.length) {
            obj.rewards = message.rewards.map((e) => coin_1.Coin.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
exports.TradeRecords = {
    ...
    toJSON(message) {
        ...
        if ((_a = message.latestTradeRecords) === null || _a === void 0 ? void 0 : _a.length) {
            obj.latestTradeRecords = message.latestTradeRecords.map((e) => exports.TradeRecord.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
exports.AggregateSubaccountVolumeRecord = {
    ...
    toJSON(message) {
        ...
        if ((_a = message.marketVolumes) === null || _a === void 0 ? void 0 : _a.length) {
            obj.marketVolumes = message.marketVolumes.map((e) => exports.MarketVolume.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
exports.MarketVolume = {
    ...
    toJSON(message) {
        ...
        if (message.volume !== undefined) {
            obj.volume = exports.VolumeRecord.toJSON(message.volume);
        }
        return obj;
    },
    create(base) {
