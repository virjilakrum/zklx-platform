...
exports.BlacklistEthereumAddressesProposal = {
    ...
    fromJSON(object) {
        return {
            ...
            blacklistAddresses: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.blacklistAddresses)
                ? object.blacklistAddresses.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_a = message.blacklistAddresses) === null || _a === void 0 ? void 0 : _a.length) {
            obj.blacklistAddresses = message.blacklistAddresses;
        }
        return obj;
    },
    create(base) {
