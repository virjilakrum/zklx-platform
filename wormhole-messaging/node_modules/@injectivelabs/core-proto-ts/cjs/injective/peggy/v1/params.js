...
exports.Params = {
    ...
    fromJSON(object) {
        return {
            peggyId: isSet(object.peggyId) ? globalThis.String(object.peggyId) : "",
            contractSourceHash: isSet(object.contractSourceHash) ? globalThis.String(object.contractSourceHash) : "",
            bridgeEthereumAddress: isSet(object.bridgeEthereumAddress) ? globalThis.String(object.bridgeEthereumAddress) : "",
            bridgeChainId: isSet(object.bridgeChainId) ? globalThis.String(object.bridgeChainId) : "0",
            signedValsetsWindow: isSet(object.signedValsetsWindow) ? globalThis.String(object.signedValsetsWindow) : "0",
            signedBatchesWindow: isSet(object.signedBatchesWindow) ? globalThis.String(object.signedBatchesWindow) : "0",
            signedClaimsWindow: isSet(object.signedClaimsWindow) ? globalThis.String(object.signedClaimsWindow) : "0",
            targetBatchTimeout: isSet(object.targetBatchTimeout) ? globalThis.String(object.targetBatchTimeout) : "0",
            averageBlockTime: isSet(object.averageBlockTime) ? globalThis.String(object.averageBlockTime) : "0",
            averageEthereumBlockTime: isSet(object.averageEthereumBlockTime)
                ? globalThis.String(object.averageEthereumBlockTime)
                : "0",
            ...
            unbondSlashingValsetsWindow: isSet(object.unbondSlashingValsetsWindow)
                ? globalThis.String(object.unbondSlashingValsetsWindow)
                : "0",
            slashFractionBadEthSignature: isSet(object.slashFractionBadEthSignature)
                ...
                : new Uint8Array(0),
            cosmosCoinDenom: isSet(object.cosmosCoinDenom) ? globalThis.String(object.cosmosCoinDenom) : "",
            cosmosCoinErc20Contract: isSet(object.cosmosCoinErc20Contract)
                ? globalThis.String(object.cosmosCoinErc20Contract)
                : "",
            claimSlashingEnabled: isSet(object.claimSlashingEnabled)
                ? globalThis.Boolean(object.claimSlashingEnabled)
                : false,
            bridgeContractStartHeight: isSet(object.bridgeContractStartHeight)
                ? globalThis.String(object.bridgeContractStartHeight)
                : "0",
    ...
    toJSON(message) {
        ...
        if (message.slashFractionValset.length !== 0) {
            obj.slashFractionValset = base64FromBytes(message.slashFractionValset);
        }
        if (message.slashFractionBatch.length !== 0) {
            obj.slashFractionBatch = base64FromBytes(message.slashFractionBatch);
        }
        if (message.slashFractionClaim.length !== 0) {
            obj.slashFractionClaim = base64FromBytes(message.slashFractionClaim);
        }
        if (message.slashFractionConflictingClaim.length !== 0) {
            obj.slashFractionConflictingClaim = base64FromBytes(message.slashFractionConflictingClaim);
        }
        if (message.unbondSlashingValsetsWindow !== "0") {
            obj.unbondSlashingValsetsWindow = message.unbondSlashingValsetsWindow;
        }
        if (message.slashFractionBadEthSignature.length !== 0) {
            obj.slashFractionBadEthSignature = base64FromBytes(message.slashFractionBadEthSignature);
        }
        if (message.cosmosCoinDenom !== "") {
            obj.cosmosCoinDenom = message.cosmosCoinDenom;
        }
        if (message.cosmosCoinErc20Contract !== "") {
            obj.cosmosCoinErc20Contract = message.cosmosCoinErc20Contract;
        }
        if (message.claimSlashingEnabled === true) {
            obj.claimSlashingEnabled = message.claimSlashingEnabled;
        }
        if (message.bridgeContractStartHeight !== "0") {
            obj.bridgeContractStartHeight = message.bridgeContractStartHeight;
        }
        if (message.valsetReward !== undefined) {
            obj.valsetReward = coin_1.Coin.toJSON(message.valsetReward);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.slashFractionValset = (_l = object.slashFractionValset) !== null && _l !== void 0 ? _l : new Uint8Array(0);
        message.slashFractionBatch = (_m = object.slashFractionBatch) !== null && _m !== void 0 ? _m : new Uint8Array(0);
        message.slashFractionClaim = (_o = object.slashFractionClaim) !== null && _o !== void 0 ? _o : new Uint8Array(0);
        message.slashFractionConflictingClaim = (_p = object.slashFractionConflictingClaim) !== null && _p !== void 0 ? _p : new Uint8Array(0);
        message.unbondSlashingValsetsWindow = (_q = object.unbondSlashingValsetsWindow) !== null && _q !== void 0 ? _q : "0";
        message.slashFractionBadEthSignature = (_r = object.slashFractionBadEthSignature) !== null && _r !== void 0 ? _r : new Uint8Array(0);
