...
function createBaseEventAttestationObserved() {
    return { attestationType: 0, bridgeContract: "", bridgeChainId: "0", attestationId: new Uint8Array(0), nonce: "0" };
}
exports.EventAttestationObserved = {
    ...
    fromJSON(object) {
        return {
            ...
            bridgeContract: isSet(object.bridgeContract) ? globalThis.String(object.bridgeContract) : "",
            bridgeChainId: isSet(object.bridgeChainId) ? globalThis.String(object.bridgeChainId) : "0",
            attestationId: isSet(object.attestationId) ? bytesFromBase64(object.attestationId) : new Uint8Array(0),
    ...
    toJSON(message) {
        const obj = {};
        if (message.attestationType !== 0) {
            obj.attestationType = (0, attestation_1.claimTypeToJSON)(message.attestationType);
        }
        if (message.bridgeContract !== "") {
        ...
        if (message.attestationId.length !== 0) {
            obj.attestationId = base64FromBytes(message.attestationId);
        }
        if (message.nonce !== "0") {
    ...
    fromPartial(object) {
        ...
        message.attestationId = (_d = object.attestationId) !== null && _d !== void 0 ? _d : new Uint8Array(0);
...
exports.EventOutgoingBatch = {
    ...
    fromJSON(object) {
        return {
            ...
            orchestratorAddress: isSet(object.orchestratorAddress) ? globalThis.String(object.orchestratorAddress) : "",
            batchNonce: isSet(object.batchNonce) ? globalThis.String(object.batchNonce) : "0",
            batchTimeout: isSet(object.batchTimeout) ? globalThis.String(object.batchTimeout) : "0",
            batchTxIds: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.batchTxIds)
                ? object.batchTxIds.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_a = message.batchTxIds) === null || _a === void 0 ? void 0 : _a.length) {
            obj.batchTxIds = message.batchTxIds;
        }
        return obj;
    },
    create(base) {
...
exports.EventOutgoingBatchCanceled = {
    ...
    fromJSON(object) {
        return {
            bridgeContract: isSet(object.bridgeContract) ? globalThis.String(object.bridgeContract) : "",
            bridgeChainId: isSet(object.bridgeChainId) ? globalThis.String(object.bridgeChainId) : "0",
            batchId: isSet(object.batchId) ? globalThis.String(object.batchId) : "0",
            nonce: isSet(object.nonce) ? globalThis.String(object.nonce) : "0",
        };
    },
    toJSON(message) {
...
exports.EventValsetUpdateRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            valsetHeight: isSet(object.valsetHeight) ? globalThis.String(object.valsetHeight) : "0",
            valsetMembers: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.valsetMembers)
    ...
    toJSON(message) {
        ...
        if (message.valsetHeight !== "0") {
            obj.valsetHeight = message.valsetHeight;
        }
        if ((_a = message.valsetMembers) === null || _a === void 0 ? void 0 : _a.length) {
            obj.valsetMembers = message.valsetMembers.map((e) => types_1.BridgeValidator.toJSON(e));
        }
        if (message.rewardAmount !== "") {
...
exports.EventSetOrchestratorAddresses = {
    ...
    fromJSON(object) {
        return {
            ...
            orchestratorAddress: isSet(object.orchestratorAddress) ? globalThis.String(object.orchestratorAddress) : "",
            operatorEthAddress: isSet(object.operatorEthAddress) ? globalThis.String(object.operatorEthAddress) : "",
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.operatorEthAddress !== "") {
            obj.operatorEthAddress = message.operatorEthAddress;
        }
        return obj;
    },
    create(base) {
...
exports.EventSendToEth = {
    ...
    fromJSON(object) {
        return {
            outgoingTxId: isSet(object.outgoingTxId) ? globalThis.String(object.outgoingTxId) : "0",
...
function createBaseEventAttestationVote() {
    return { eventNonce: "0", attestationId: new Uint8Array(0), voter: "" };
}
exports.EventAttestationVote = {
    ...
    fromPartial(object) {
        ...
        message.attestationId = (_b = object.attestationId) !== null && _b !== void 0 ? _b : new Uint8Array(0);
...
exports.EventDepositClaim = {
    ...
    fromJSON(object) {
        return {
            eventNonce: isSet(object.eventNonce) ? globalThis.String(object.eventNonce) : "0",
            eventHeight: isSet(object.eventHeight) ? globalThis.String(object.eventHeight) : "0",
            attestationId: isSet(object.attestationId) ? bytesFromBase64(object.attestationId) : new Uint8Array(0),
    ...
    toJSON(message) {
        ...
        if (message.eventHeight !== "0") {
            obj.eventHeight = message.eventHeight;
        }
        if (message.attestationId.length !== 0) {
            obj.attestationId = base64FromBytes(message.attestationId);
        }
    ...
    fromPartial(object) {
        ...
        message.attestationId = (_c = object.attestationId) !== null && _c !== void 0 ? _c : new Uint8Array(0);
...
exports.EventCancelSendToEth = {
    ...
    fromJSON(object) {
        return { outgoingTxId: isSet(object.outgoingTxId) ? globalThis.String(object.outgoingTxId) : "0" };
    },
    toJSON(message) {
        const obj = {};
        if (message.outgoingTxId !== "0") {
...
exports.EventSubmitBadSignatureEvidence = {
    ...
    fromJSON(object) {
        return {
            badEthSignature: isSet(object.badEthSignature) ? globalThis.String(object.badEthSignature) : "",
            badEthSignatureSubject: isSet(object.badEthSignatureSubject)
                ? globalThis.String(object.badEthSignatureSubject)
                : "",
        };
    },
    toJSON(message) {
