...
exports.Params = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.defaultRedemptionNoticePeriodDuration !== undefined) {
            obj.defaultRedemptionNoticePeriodDuration = duration_1.Duration.toJSON(message.defaultRedemptionNoticePeriodDuration);
        }
        return obj;
    },
    create(base) {
...
exports.InsuranceFund = {
    ...
    fromJSON(object) {
        return {
            depositDenom: isSet(object.depositDenom) ? globalThis.String(object.depositDenom) : "",
            insurancePoolTokenDenom: isSet(object.insurancePoolTokenDenom)
                ? globalThis.String(object.insurancePoolTokenDenom)
                : "",
            ...
            totalShare: isSet(object.totalShare) ? globalThis.String(object.totalShare) : "",
            marketId: isSet(object.marketId) ? globalThis.String(object.marketId) : "",
            marketTicker: isSet(object.marketTicker) ? globalThis.String(object.marketTicker) : "",
    ...
    toJSON(message) {
        ...
        if (message.insurancePoolTokenDenom !== "") {
            obj.insurancePoolTokenDenom = message.insurancePoolTokenDenom;
        }
        if (message.redemptionNoticePeriodDuration !== undefined) {
            obj.redemptionNoticePeriodDuration = duration_1.Duration.toJSON(message.redemptionNoticePeriodDuration);
        }
        if (message.balance !== "") {
            obj.balance = message.balance;
        }
        if (message.totalShare !== "") {
            obj.totalShare = message.totalShare;
        }
        if (message.marketId !== "") {
            obj.marketId = message.marketId;
        }
        if (message.marketTicker !== "") {
            obj.marketTicker = message.marketTicker;
        }
        if (message.oracleBase !== "") {
...
exports.RedemptionSchedule = {
    ...
    toJSON(message) {
        ...
        if (message.redemptionAmount !== undefined) {
            obj.redemptionAmount = coin_1.Coin.toJSON(message.redemptionAmount);
        }
        return obj;
    },
    create(base) {
...
exports.EventInsuranceFundUpdate = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.fund !== undefined) {
            obj.fund = exports.InsuranceFund.toJSON(message.fund);
        }
        return obj;
    },
    create(base) {
...
exports.EventRequestRedemption = {
    ...
    toJSON(message) {
        const obj = {};
        if (message.schedule !== undefined) {
            obj.schedule = exports.RedemptionSchedule.toJSON(message.schedule);
        }
        return obj;
    },
    create(base) {
...
exports.EventWithdrawRedemption = {
    ...
    toJSON(message) {
        ...
        if (message.redeemCoin !== undefined) {
            obj.redeemCoin = coin_1.Coin.toJSON(message.redeemCoin);
        }
        return obj;
    },
    create(base) {
...
exports.EventUnderwrite = {
    ...
    fromJSON(object) {
        return {
            underwriter: isSet(object.underwriter) ? globalThis.String(object.underwriter) : "",
            marketId: isSet(object.marketId) ? globalThis.String(object.marketId) : "",
    ...
    toJSON(message) {
        ...
        if (message.shares !== undefined) {
            obj.shares = coin_1.Coin.toJSON(message.shares);
        }
        return obj;
    },
    create(base) {
