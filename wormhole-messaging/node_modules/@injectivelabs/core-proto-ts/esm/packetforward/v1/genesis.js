...
export const Params = {
    ...
    fromJSON(object) {
        return { feePercentage: isSet(object.feePercentage) ? globalThis.String(object.feePercentage) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.feePercentage !== "") {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseParams();
        message.feePercentage = (_a = object.feePercentage) !== null && _a !== void 0 ? _a : "";
        return message;
    },
};
...
export const InFlightPacket = {
    ...
    fromPartial(object) {
        ...
        message.packetData = (_h = object.packetData) !== null && _h !== void 0 ? _h : new Uint8Array(0);
