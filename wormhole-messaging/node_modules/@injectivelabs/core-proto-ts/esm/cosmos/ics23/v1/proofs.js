...
export const ExistenceProof = {
    ...
    fromJSON(object) {
        return {
            ...
            path: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.path) ? object.path.map((e) => InnerOp.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
...
export const BatchProof = {
    ...
    fromJSON(object) {
        return {
            entries: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.entries) ? object.entries.map((e) => BatchEntry.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
