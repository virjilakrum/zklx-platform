...
export const Input = {
    ...
    fromJSON(object) {
        return {
            ...
            coins: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.coins) ? object.coins.map((e) => Coin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
...
export const Supply = {
    ...
    fromJSON(object) {
        return { total: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.total) ? object.total.map((e) => Coin.fromJSON(e)) : [] };
    },
    toJSON(message) {
        var _a;
        const obj = {};
