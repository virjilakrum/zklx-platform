...
export const Namespace = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.rolePermissions).forEach(([key, value]) => {
            Namespace_RolePermissionsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        Object.entries(message.addressRoles).forEach(([key, value]) => {
            Namespace_AddressRolesEntry.encode({ key: key, value }, writer.uint32(58).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    const entry6 = Namespace_RolePermissionsEntry.decode(reader, reader.uint32());
                ...
                case 7:
                    ...
                    const entry7 = Namespace_AddressRolesEntry.decode(reader, reader.uint32());
...
export const Namespace_RolePermissionsEntry = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.key !== "") {
    ...
    create(base) {
        return Namespace_RolePermissionsEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseNamespace_RolePermissionsEntry();
...
export const Namespace_AddressRolesEntry = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
        }
    ...
    create(base) {
        return Namespace_AddressRolesEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseNamespace_AddressRolesEntry();
...
export const Roles = {
    ...
    create(base) {
        return Roles.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseRoles();
...
export const Voucher = {
    ...
    fromJSON(object) {
        return { coins: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.coins) ? object.coins.map((e) => Coin.fromJSON(e)) : [] };
    },
    toJSON(message) {
        var _a;
        const obj = {};
