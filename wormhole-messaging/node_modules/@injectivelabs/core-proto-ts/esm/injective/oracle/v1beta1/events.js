...
export const SetBandIBCPriceEvent = {
    ...
    fromJSON(object) {
        return {
            ...
            prices: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.prices) ? object.prices.map((e) => globalThis.String(e)) : [],
            resolveTime: isSet(object.resolveTime) ? globalThis.String(object.resolveTime) : "0",
            requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "0",
    ...
    toJSON(message) {
        ...
        if ((_b = message.prices) === null || _b === void 0 ? void 0 : _b.length) {
...
export const EventBandIBCAckSuccess = {
    ...
    fromJSON(object) {
        return {
            ackResult: isSet(object.ackResult) ? globalThis.String(object.ackResult) : "",
            clientId: isSet(object.clientId) ? globalThis.String(object.clientId) : "0",
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.ackResult !== "") {
            obj.ackResult = message.ackResult;
        }
        if (message.clientId !== "0") {
            obj.clientId = message.clientId;
        }
...
export const EventBandIBCAckError = {
    ...
    fromJSON(object) {
        return {
            ackError: isSet(object.ackError) ? globalThis.String(object.ackError) : "",
            clientId: isSet(object.clientId) ? globalThis.String(object.clientId) : "0",
        };
    },
    toJSON(message) {
...
export const EventBandIBCResponseTimeout = {
    ...
    fromJSON(object) {
        return { clientId: isSet(object.clientId) ? globalThis.String(object.clientId) : "0" };
    },
    toJSON(message) {
        const obj = {};
        if (message.clientId !== "0") {
...
export const EventSetPythPrices = {
    ...
    fromJSON(object) {
        return {
            prices: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.prices) ? object.prices.map((e) => PythPriceState.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.prices) === null || _a === void 0 ? void 0 : _a.length) {
            obj.prices = message.prices.map((e) => PythPriceState.toJSON(e));
        }
        return obj;
    },
    create(base) {
