...
export const AuthorizeBandOracleRequestProposal = {
    ...
    toJSON(message) {
        ...
        if (message.request !== undefined) {
            obj.request = BandOracleRequest.toJSON(message.request);
        }
        return obj;
    },
    create(base) {
...
export const UpdateBandOracleRequestProposal = {
    ...
    fromJSON(object) {
        return {
            title: isSet(object.title) ? globalThis.String(object.title) : "",
            description: isSet(object.description) ? globalThis.String(object.description) : "",
            deleteRequestIds: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.deleteRequestIds)
                ? object.deleteRequestIds.map((e) => globalThis.String(e))
                : [],
    ...
    toJSON(message) {
        ...
        if ((_a = message.deleteRequestIds) === null || _a === void 0 ? void 0 : _a.length) {
            obj.deleteRequestIds = message.deleteRequestIds;
        }
        if (message.updateOracleRequest !== undefined) {
            obj.updateOracleRequest = BandOracleRequest.toJSON(message.updateOracleRequest);
        }
        return obj;
    },
    create(base) {
