...
export const Params = {
    ...
    fromJSON(object) {
        return { pythContract: isSet(object.pythContract) ? globalThis.String(object.pythContract) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.pythContract !== "") {
            obj.pythContract = message.pythContract;
        }
        return obj;
    },
    create(base) {
...
export const BandPriceState = {
    ...
    fromJSON(object) {
        return {
            ...
            resolveTime: isSet(object.resolveTime) ? globalThis.String(object.resolveTime) : "0",
...
export const ProviderState = {
    ...
    fromJSON(object) {
        return {
            ...
            providerPriceStates: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.providerPriceStates)
    ...
    toJSON(message) {
        ...
        const obj = {};
        if (message.providerInfo !== undefined) {
            obj.providerInfo = ProviderInfo.toJSON(message.providerInfo);
        }
        if ((_a = message.providerPriceStates) === null || _a === void 0 ? void 0 : _a.length) {
            obj.providerPriceStates = message.providerPriceStates.map((e) => ProviderPriceState.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
export const ProviderPriceState = {
    ...
    toJSON(message) {
        ...
        if (message.state !== undefined) {
            obj.state = PriceState.toJSON(message.state);
        }
        return obj;
    },
    create(base) {
...
export const PythPriceState = {
    ...
    fromJSON(object) {
        return {
            ...
            emaPrice: isSet(object.emaPrice) ? globalThis.String(object.emaPrice) : "",
            emaConf: isSet(object.emaConf) ? globalThis.String(object.emaConf) : "",
            conf: isSet(object.conf) ? globalThis.String(object.conf) : "",
            publishTime: isSet(object.publishTime) ? globalThis.String(object.publishTime) : "0",
            priceState: isSet(object.priceState) ? PriceState.fromJSON(object.priceState) : undefined,
        };
    },
    toJSON(message) {
        ...
        if (message.emaPrice !== "") {
            obj.emaPrice = message.emaPrice;
        }
        if (message.emaConf !== "") {
            obj.emaConf = message.emaConf;
        }
        if (message.conf !== "") {
            obj.conf = message.conf;
        }
        if (message.publishTime !== "0") {
            obj.publishTime = message.publishTime;
        }
        if (message.priceState !== undefined) {
            obj.priceState = PriceState.toJSON(message.priceState);
        }
...
export const BandOracleRequest = {
    ...
    fromJSON(object) {
        return {
            requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "0",
            oracleScriptId: isSet(object.oracleScriptId) ? globalThis.String(object.oracleScriptId) : "0",
            symbols: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.symbols) ? object.symbols.map((e) => globalThis.String(e)) : [],
            askCount: isSet(object.askCount) ? globalThis.String(object.askCount) : "0",
            minCount: isSet(object.minCount) ? globalThis.String(object.minCount) : "0",
            feeLimit: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.feeLimit) ? object.feeLimit.map((e) => Coin.fromJSON(e)) : [],
            prepareGas: isSet(object.prepareGas) ? globalThis.String(object.prepareGas) : "0",
            executeGas: isSet(object.executeGas) ? globalThis.String(object.executeGas) : "0",
            minSourceCount: isSet(object.minSourceCount) ? globalThis.String(object.minSourceCount) : "0",
        };
    },
    toJSON(message) {
        var _a, _b;
        ...
        if ((_a = message.symbols) === null || _a === void 0 ? void 0 : _a.length) {
            obj.symbols = message.symbols;
        }
        if (message.askCount !== "0") {
            obj.askCount = message.askCount;
        }
        if (message.minCount !== "0") {
            obj.minCount = message.minCount;
        }
        if ((_b = message.feeLimit) === null || _b === void 0 ? void 0 : _b.length) {
            obj.feeLimit = message.feeLimit.map((e) => Coin.toJSON(e));
        }
        if (message.prepareGas !== "0") {
            obj.prepareGas = message.prepareGas;
        }
        if (message.executeGas !== "0") {
            obj.executeGas = message.executeGas;
        }
        if (message.minSourceCount !== "0") {
            obj.minSourceCount = message.minSourceCount;
        }
        return obj;
    },
    create(base) {
...
export const BandIBCParams = {
    ...
    fromJSON(object) {
        return {
            bandIbcEnabled: isSet(object.bandIbcEnabled) ? globalThis.Boolean(object.bandIbcEnabled) : false,
            ibcRequestInterval: isSet(object.ibcRequestInterval) ? globalThis.String(object.ibcRequestInterval) : "0",
            ibcSourceChannel: isSet(object.ibcSourceChannel) ? globalThis.String(object.ibcSourceChannel) : "",
            ibcVersion: isSet(object.ibcVersion) ? globalThis.String(object.ibcVersion) : "",
            ibcPortId: isSet(object.ibcPortId) ? globalThis.String(object.ibcPortId) : "",
            legacyOracleIds: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.legacyOracleIds)
                ? object.legacyOracleIds.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        const obj = {};
        if (message.bandIbcEnabled === true) {
            obj.bandIbcEnabled = message.bandIbcEnabled;
        }
        if (message.ibcRequestInterval !== "0") {
            obj.ibcRequestInterval = message.ibcRequestInterval;
        }
        if (message.ibcSourceChannel !== "") {
            obj.ibcSourceChannel = message.ibcSourceChannel;
        }
        if (message.ibcVersion !== "") {
            obj.ibcVersion = message.ibcVersion;
        }
        if (message.ibcPortId !== "") {
            obj.ibcPortId = message.ibcPortId;
        }
        if ((_a = message.legacyOracleIds) === null || _a === void 0 ? void 0 : _a.length) {
            obj.legacyOracleIds = message.legacyOracleIds;
        }
        return obj;
    },
    create(base) {
...
export const LastPriceTimestamps = {
    ...
    fromJSON(object) {
        return {
            lastPriceTimestamps: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.lastPriceTimestamps)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.lastPriceTimestamps) === null || _a === void 0 ? void 0 : _a.length) {
            obj.lastPriceTimestamps = message.lastPriceTimestamps.map((e) => SymbolPriceTimestamp.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
export const PriceRecords = {
    ...
    fromJSON(object) {
        return {
            oracle: isSet(object.oracle) ? oracleTypeFromJSON(object.oracle) : 0,
            symbolId: isSet(object.symbolId) ? globalThis.String(object.symbolId) : "",
            latestPriceRecords: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.latestPriceRecords)
    ...
    toJSON(message) {
        ...
        if ((_a = message.latestPriceRecords) === null || _a === void 0 ? void 0 : _a.length) {
            obj.latestPriceRecords = message.latestPriceRecords.map((e) => PriceRecord.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
export const MetadataStatistics = {
    ...
    fromJSON(object) {
        return {
            ...
            recordsSampleSize: isSet(object.recordsSampleSize) ? globalThis.Number(object.recordsSampleSize) : 0,
            mean: isSet(object.mean) ? globalThis.String(object.mean) : "",
            twap: isSet(object.twap) ? globalThis.String(object.twap) : "",
            firstTimestamp: isSet(object.firstTimestamp) ? globalThis.String(object.firstTimestamp) : "0",
            ...
            medianPrice: isSet(object.medianPrice) ? globalThis.String(object.medianPrice) : "",
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.recordsSampleSize !== 0) {
            obj.recordsSampleSize = Math.round(message.recordsSampleSize);
        }
        if (message.mean !== "") {
        ...
        if (message.firstTimestamp !== "0") {
            obj.firstTimestamp = message.firstTimestamp;
        }
        if (message.lastTimestamp !== "0") {
        ...
        if (message.medianPrice !== "") {
            obj.medianPrice = message.medianPrice;
        }
        return obj;
    },
    create(base) {
...
export const PriceAttestation = {
    ...
    fromJSON(object) {
        return {
            ...
            conf: isSet(object.conf) ? globalThis.String(object.conf) : "0",
            expo: isSet(object.expo) ? globalThis.Number(object.expo) : 0,
            emaPrice: isSet(object.emaPrice) ? globalThis.String(object.emaPrice) : "0",
            emaConf: isSet(object.emaConf) ? globalThis.String(object.emaConf) : "0",
            emaExpo: isSet(object.emaExpo) ? globalThis.Number(object.emaExpo) : 0,
            publishTime: isSet(object.publishTime) ? globalThis.String(object.publishTime) : "0",
        };
    },
    toJSON(message) {
        ...
        if (message.expo !== 0) {
            obj.expo = Math.round(message.expo);
        }
        if (message.emaPrice !== "0") {
            obj.emaPrice = message.emaPrice;
        }
        ...
        if (message.emaExpo !== 0) {
            obj.emaExpo = Math.round(message.emaExpo);
        }
        if (message.publishTime !== "0") {
            obj.publishTime = message.publishTime;
        }
