...
export const FeedConfig = {
    ...
    toJSON(message) {
        ...
        if (message.moduleParams !== undefined) {
            obj.moduleParams = ModuleParams.toJSON(message.moduleParams);
        }
        return obj;
    },
    create(base) {
...
export const SetConfigProposal = {
    ...
    toJSON(message) {
        ...
        if (message.config !== undefined) {
            obj.config = FeedConfig.toJSON(message.config);
        }
        return obj;
    },
    create(base) {
...
export const SetBatchConfigProposal = {
    ...
    toJSON(message) {
        ...
        if ((_c = message.feedProperties) === null || _c === void 0 ? void 0 : _c.length) {
            obj.feedProperties = message.feedProperties.map((e) => FeedProperties.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
export const GasReimbursements = {
    ...
    toJSON(message) {
        ...
        if ((_a = message.reimbursements) === null || _a === void 0 ? void 0 : _a.length) {
            obj.reimbursements = message.reimbursements.map((e) => Coin.toJSON(e));
        }
        return obj;
    },
    create(base) {
...
export const EventConfigSet = {
    ...
    toJSON(message) {
        ...
        if (message.configInfo !== undefined) {
            obj.configInfo = FeedConfigInfo.toJSON(message.configInfo);
        }
        return obj;
    },
    create(base) {
